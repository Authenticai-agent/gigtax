 ...
 *
 * Notice 2026-10 set 72.5 cents from January 1. Announcement 2026-11 modified it
 * and raised the rate to 76 cents for expenses paid or incurred on or after
 * July 1, 2026. Quoting one figure for "the 2026 rate" is wrong for half the
...
export const DEDUCTION_GROUPS: DeductionGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail: 'Automatically deducted against your income tax. You do not have to claim it, but it is worth knowing it is there before you conclude the self-employment rate is as severe as it first appears.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Repairs and maintenance', detail: 'Routine repairs are deductible now. Improvements that add value or extend the life of the property have to be capitalized and depreciated instead.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Software and subscriptions', detail: 'Deductible in the year you pay. Software developed for the business can be expensed in the year of cost rather than amortized.' },
    ],
  },
  {
    key: 'people',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Per diem instead of receipts', detail: 'A fixed daily amount can replace itemized meal receipts. Drivers subject to hours-of-service rules use a higher rate at a different percentage — see the truck driver page.' },
    ],
  },
  {
    key: 'running',
    ...
    items: [
      ...
      { name: 'Licenses, permits and regulatory fees', detail: 'Professional licensing, trade registration, local business licenses, industry-specific registrations.' },
      { name: 'Professional memberships', detail: 'Trade bodies, professional associations, chambers of commerce. Clubs organized for pleasure or recreation are not deductible.' },
      ...
      { name: 'Business taxes and licenses', detail: 'State and local business taxes and property tax on business assets. Federal income tax is not deductible.' },
      ...
      { name: 'Charitable donations', detail: 'Not a business deduction on a sole trader return. They go on your personal itemized deductions instead, which is why many people get no benefit at all.' },
    ],
  },
];
