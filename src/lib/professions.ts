...
export const PROFESSIONS: Profession[] = [
  ...
  { key: 'ai_consultant', slug: 'ai-consultant', name: 'AI consultant', lead: 'Compute is the unusual line. GPU hours and API spend are ordinary business expenses in the year incurred, and they can dwarf every other deduction in a month where a model is being trained.', watch: 'Compute spend is lumpy in a way that wrecks quarterly estimates: a quarter where you train a model can swing profit by more than the safe-harbour cushion. Pay estimates on the prior-year safe harbour rather than the current-year projection and the swing stops mattering.' },
  ...
  { key: 'therapist', slug: 'therapist', name: 'Therapist', lead: 'Supervision hours are a deductible professional expense while you are licensed and maintaining skills. The same spend before licensure is qualifying for a new trade, which is not deductible at all.', watch: 'Whether you are an SSTB matters here in a way it does not for most trades — health is a specified service trade, so the QBI deduction starts phasing out once taxable income passes the threshold and disappears above it. Sliding-scale fees you choose not to charge are not a deduction; they are simply income you did not earn.' },
  ...
  { key: 'bookkeeper_accountant', slug: 'bookkeeper', name: 'Bookkeeper or accountant', lead: 'You will do this correctly for clients and badly for yourself. The licensing fees an EA or CPA pays are deductible professional expenses and are the line most often left off an own-business return.', watch: 'The QBI question bites: accounting is a specified service trade, so the deduction phases out above the income threshold rather than continuing. Professional indemnity cover and EA or CPA licensing are both ordinary expenses, and the software you resell to clients is income to you before it is a deduction.' },
